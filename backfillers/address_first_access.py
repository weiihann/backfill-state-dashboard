"""Backfiller for address_first_access table."""

from typing import List
from core.backfiller import BaseBackfiller


class AddressFirstAccessBackfiller(BaseBackfiller):
    """Backfiller for int_address_first_access table."""
    
    @property
    def table_name(self) -> str:
        return "mainnet.int_address_first_access"
    ...
    def description(self) -> str:
        return "Xatu Int Address First Access Backfill"
