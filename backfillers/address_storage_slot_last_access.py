"""Backfiller for address_storage_slot_last_access table."""

from typing import List
from core.backfiller import BaseBackfiller


class AddressStorageSlotLastAccessBackfiller(BaseBackfiller):
    """Backfiller for int_address_storage_slot_last_access table."""
    
    @property
    def table_name(self) -> str:
        return "mainnet.int_address_storage_slot_last_access"
    ...
    def description(self) -> str:
        return "Xatu Int Address Storage Slot Last Access Backfill"
...
SELECT
    ...
    argMax(s.value, s.block_number) AS value
