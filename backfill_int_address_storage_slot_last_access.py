"""
Backfill script for int_address_storage_slot_last_access table.

This script fills the mainnet.int_address_storage_slot_last_access table by combining data from
storage diffs and storage reads tables and determining the last access for each address+slot combination.
"""
...
# Configuration
TARGET_TABLE = "mainnet.int_address_storage_slot_last_access"
SOURCE_TABLES = [
...
def main():
    ...
    print("=" * 80)
    print("Xatu Int Address Storage Slot Last Access Backfill")
    print("=" * 80)
